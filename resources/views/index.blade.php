...
<html lang="en">
<head>
  <title>Data COVID-19 Provoinsi Bali</title>
  <meta charset="utf-8">
...
<div class="container mt-4">
    <h4>Informasi Sebaran Kasus Covid-19 di Bali Sampai Dengan Tanggal {{$tanggalSekarang}}</h4>
    <div class="row">  
		    <div class="col-md-12">
		        <div class="card mb-3">
		        <div class="card-header text-white" style="background-color: #e57373;">
		            <h5>Terkonfirmasi Positif COVID-19</h5>
		            <p class="card-text">{{$positif[0]->positif}} Orang</p> 
		        </div>
            <div class="card-body">
		            <div class="row">
            		    <div class="col-md-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color: #FF7F50;">
            ...
            <div class="col-md-4">
                <div class="card text-white mb-3" style="max-width: 18rem;background-color: #7cb342;">
                    <div class="card-header">Sembuh</div>
                      <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card text-black mb-3" style="max-width: 18rem;background-color: #fff59d;">
  ...
  <div class="row mt-4">
              ...
              <form action="/search" method="POST">
                @csrf
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Input Tanggal</label>
      ...
      <div class="col-sm-8">
		<div class="sec-title light text-center">
			...
			<div class="text"> Titik tidak menunjukkan alamat, hanya nama kabupaten.</div>
              <div id="map"></div>
            <div class="card-footer" style="background: white">
              <div class="row">
                <div class="col-6">
                  Color Start
                  <input type="color" value="#F08080" class="form-control" id="colorStart">
                </div>
                <div class="col-6">
                  Color End
                  <input type="color" value="#800000" class="form-control" id="colorEnd">
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-12">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="table-responsive">
                  <table id="example" class="table table-striped table-primary rounded" >
                    <thead>
                      <tr>
                        <th scope="col">#</th>
